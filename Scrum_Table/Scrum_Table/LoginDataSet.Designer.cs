...
namespace Scrum_Table {
    ...
    public partial class LoginDataSet : global::System.Data.DataSet {
        ...
        public partial class loginDataTable : global::System.Data.TypedTableBase<loginRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public loginRow FindBykullaniciAdi(string kullaniciAdi) {
...
namespace Scrum_Table.LoginDataSetTableAdapters {
    ...
    public partial class loginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `login` WHERE ((`kullaniciAdi` = ?) AND ((? = 1 AND `sifre` IS NULL) " +
                "OR (`sifre` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `login` (`kullaniciAdi`, `sifre`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `login` SET `kullaniciAdi` = ?, `sifre` = ? WHERE ((`kullaniciAdi` = ?) AN" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Scrum_Table.Properties.Settings.Default.LoginConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT kullaniciAdi, sifre FROM login";
